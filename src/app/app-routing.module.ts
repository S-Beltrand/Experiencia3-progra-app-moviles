...
const routes: Routes = [
  ...
  {
    path: 'buenos-m',
    loadChildren: () => import('./pages/buenos-m/buenos-m.module').then( m => m.BuenosMPageModule)
  },
  {
    path: 'la-cosa',
    loadChildren: () => import('./pages/la-cosa/la-cosa.module').then( m => m.LaCosaPageModule)
  },
  {
    path: 'the-mist',
    loadChildren: () => import('./pages/the-mist/the-mist.module').then( m => m.TheMistPageModule)
  },
];
